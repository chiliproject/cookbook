# Chef Cookbook for ChiliProject [![Build Status](https://secure.travis-ci.org/chiliproject/cookbook.png?branch=master)](https://travis-ci.org/chiliproject/cookbook)
